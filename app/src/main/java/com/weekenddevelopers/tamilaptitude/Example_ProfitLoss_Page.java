...
public class Example_ProfitLoss_Page extends AppCompatActivity implements MoPubInterstitial.InterstitialAdListener  {
//    AdView adView;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_example__profit_loss__page);
