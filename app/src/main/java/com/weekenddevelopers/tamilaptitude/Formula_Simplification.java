...
public class Formula_Simplification extends AppCompatActivity implements MoPubInterstitial.InterstitialAdListener  {
//    AdView adView;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_formula__simplification);
        ...
        Activity activity = Formula_Simplification.this;
        mInterstitial = new MoPubInterstitial(activity,"15e8b06031d4497daf8d5b5f0099ffef");
