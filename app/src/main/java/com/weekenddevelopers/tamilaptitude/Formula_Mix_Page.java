...
public class Formula_Mix_Page extends AppCompatActivity implements MoPubInterstitial.InterstitialAdListener  {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_formula__mix__page);
