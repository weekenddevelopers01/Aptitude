...
public class Example_Train_Page extends AppCompatActivity implements MoPubInterstitial.InterstitialAdListener  {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_example__train__page);
