...
public class Formula_Number_Page extends AppCompatActivity implements MoPubInterstitial.InterstitialAdListener{
...
//    AdView adView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_formula__number__page);
