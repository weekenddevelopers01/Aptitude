...
public class Formula_TimeWork_Page extends AppCompatActivity implements MoPubInterstitial.InterstitialAdListener  {
//AdView adView;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_formula__time_work__page);
