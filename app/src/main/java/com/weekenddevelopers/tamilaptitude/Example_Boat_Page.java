...
public class Example_Boat_Page extends AppCompatActivity implements MoPubInterstitial.InterstitialAdListener  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_example__boat__page);
