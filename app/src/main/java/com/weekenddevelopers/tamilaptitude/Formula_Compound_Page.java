...
public class Formula_Compound_Page extends AppCompatActivity implements MoPubInterstitial.InterstitialAdListener  {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_formula__compound__page);
