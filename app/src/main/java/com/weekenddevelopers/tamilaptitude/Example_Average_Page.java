...
public class Example_Average_Page extends AppCompatActivity implements MoPubInterstitial.InterstitialAdListener  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_example__average__page);
