...
public class Formula_Train_Page extends AppCompatActivity implements MoPubInterstitial.InterstitialAdListener  {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_formula__train__page);
