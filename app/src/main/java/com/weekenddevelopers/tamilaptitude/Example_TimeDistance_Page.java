...
public class Example_TimeDistance_Page extends AppCompatActivity implements MoPubInterstitial.InterstitialAdListener  {
//    AdView adView;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_example__time_distance__page);
